...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
    generate(request) {
        ...
        if (request.path && typeof request.path == 'string') {
            ...
            else request.url = request.path.split('.').reduce((a, b) => { // create url from controller string
                return a.concat('/', b)
            }, '')
            ...
            if (request.params && typeof request.params === 'object') {
                if (request.url.slice(-1) != '/') request.url.concat('/')

                // compile parameters
                const toPath = (0,path_to_regexp__WEBPACK_IMPORTED_MODULE_0__.compile)(request.url, {
            ...
            console.error("Please define path string. Example: 'notifications/count' or 'notifications' or 'notifications/:id")
            return false
        }
    },
});
